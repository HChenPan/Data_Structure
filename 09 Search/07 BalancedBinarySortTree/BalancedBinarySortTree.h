//
//文件夹: 09 Search/07 BalancedBinarySortTree
//文件名: BalancedBinarySortTree
//内　容：平衡二叉排序树相关操作列表
//Author Huangcp
...
#ifndef DATA_STRUCTURE_BALANCEDBINARYSORTTREE_H
#define DATA_STRUCTURE_BALANCEDBINARYSORTTREE_H
...
Status DeleteAVL(BBSTree *BBST, ElemType_Search e, BBSTree f, BBSTree p, Boolean *taller,
                 int mark) {//p指向当前结点，f指向p的父结点，初始化为空，*taller初始化为FALSE，mark代表f与p的关系，初始化为0
    BBSTree r;
    ElemType_Search tmp;
...
#endif //DATA_STRUCTURE_BALANCEDBINARYSORTTREE_H
